...
- [GEO Visibility Audit Tool](https://github.com/rajpalrohit04/geo-visibility-audit-tool): Tracks brand visibility across ChatGPT, Claude, Gemini, and Perplexity. Uses APIs to save costs, unlike expensive tools.
- [Internal Linking Tool](https://github.com/rajpalrohit04/Interlinking-Tool): Finds relevant internal linking opportunities across large content libraries. Uses context-based linking along with keywords.
